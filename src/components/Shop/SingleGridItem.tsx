...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[300px] mb-4">
        <Link href={`/shop-details/${item.id}`}>
          <Image src={item.imgs.previews[0]} alt="" width={220} height={220} />
        </Link>
