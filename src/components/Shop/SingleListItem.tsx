...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-7.5 group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] w-full max-w-[255px] min-h-[250px]">
        <Link href={`/shop-details/${item.id}`}>
          <Image src={item.imgs.previews[0]} alt="" width={180} height={180} />
        </Link>
